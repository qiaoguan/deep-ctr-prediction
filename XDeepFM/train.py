...
flags.DEFINE_string("cross_layer_sizes", "100,100,50", "number of units in each cross layer for NN")
...
flags.DEFINE_boolean(name="use_xdeepfm", default=True, help="whether use cross layer")
...
def main(unused_argv):
  ...
  model = tf.estimator.Estimator(
    ...
    params={
      ...
      'use_xdeepfm': FLAGS.use_xdeepfm,
      'cross_layer_sizes': FLAGS.cross_layer_sizes.split(',')
    },
    config = run_config
  )
