...
Kaiming He et all.  "Deep Residual Learning for Image Recognition,"  In CVPR,2016.
...
flags.DEFINE_string("train_data_dir", "{20190121,20190122,20190123,20190124,20190125,20190126,20190127}/v1_tfrecord/", "dir for training data")
flags.DEFINE_string("eval_data_dir", "{20190128}/v1_tfrecord/", "dir for evaluation data")
